...
var SupSub = P(MathCommand, function(_, super_) {
  ...
  _.pmathml = function() {
      var base = createMMLElement("merror").append(createMMLElement("mtext").text("No base"));
      if (this.sup != null && this.sub != null) {
	  return createMMLElement("msubsup").attr("insert_previous",0).append(base,this.sub.pmathml(),this.sup.pmathml())[0];
      } else if (this.sub != null) {
	  return createMMLElement("msub").attr("insert_previous",0).append(base,this.sub.pmathml())[0]; 
      } else if (this.sup != null) {
	  return createMMLElement("msup").attr("insert_previous",0).append(base,this.sup.pmathml())[0];
      } else
...
var Bracket = P(P(MathCommand, DelimsMixin), function(_, super_) {
  ...
  _.pmathml = function() {
      var mfenced = createMMLElement("mfenced");
